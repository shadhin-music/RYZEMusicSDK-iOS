...
#ifndef SHADHIN_RYZE_SWIFT_H
#define SHADHIN_RYZE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Shadhin_RYZE",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIColor;
IB_DESIGNABLE
SWIFT_CLASS("_TtC12Shadhin_RYZE11BLRadioView")
...
@interface BLRadioView (SWIFT_EXTENSION(Shadhin_RYZE)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (CGSize)collectionView:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end

SWIFT_CLASS("_TtC12Shadhin_RYZE8OTPField")
...
@interface OTPField (SWIFT_EXTENSION(Shadhin_RYZE)) <UITextFieldDelegate>
- (BOOL)textField:(UITextField * _Nonnull)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString * _Nonnull)string SWIFT_WARN_UNUSED_RESULT;
- (void)textFieldDidBeginEditing:(UITextField * _Nonnull)textField;
- (void)textFieldDidEndEditing:(UITextField * _Nonnull)textField;
@end

SWIFT_CLASS("_TtC12Shadhin_RYZE12OTPStackView")
@interface OTPStackView : UIStackView
- (nonnull instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end

@interface OTPStackView (SWIFT_EXTENSION(Shadhin_RYZE)) <UITextFieldDelegate>
- (void)textFieldDidBeginEditing:(UITextField * _Nonnull)textField;
- (void)textFieldDidEndEditing:(UITextField * _Nonnull)textField;
- (BOOL)textField:(UITextField * _Nonnull)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString * _Nonnull)string SWIFT_WARN_UNUSED_RESULT;
@end
...
- (void)setTitle:(NSString * _Nonnull)text;
- (void)setTitleColor:(UIColor * _Nonnull)color;
- (void)hideTitle:(BOOL)isHide;
- (void)setSeeAllColor:(UIColor * _Nonnull)color;
- (void)hideSeeAll:(BOOL)isHide;
- (void)setArtistNameColor:(UIColor * _Nonnull)color SWIFT_AVAILABILITY(ios,introduced=13.0);
- (void)hideArtistName:(BOOL)isHide;
@end

@interface RYZEArtistView (SWIFT_EXTENSION(Shadhin_RYZE)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL("_TtP12Shadhin_RYZE13RadioCallBack_")
...
SWIFT_PROTOCOL("_TtP12Shadhin_RYZE19ShadhinCoreNotifier_")
...
@class ShadhinRyzeConfig;
@class UITabBarController;
@class UINavigationController;
@class UIEvent;
SWIFT_CLASS("_TtC12Shadhin_RYZE11ShadhinRyze")
@interface ShadhinRyze : NSObject
@property (nonatomic, strong) ShadhinRyzeConfig * _Nonnull config;
...
SWIFT_CLASS("_TtC12Shadhin_RYZE17ShadhinRyzeConfig")
@interface ShadhinRyzeConfig : NSObject
@property (nonatomic) BOOL shouldHideMusicBarOnExit;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithShouldHideMusicBarOnExit:(BOOL)shouldHideMusicBarOnExit OBJC_DESIGNATED_INITIALIZER;
@end

@interface UIButton (SWIFT_EXTENSION(Shadhin_RYZE))
...
SWIFT_CLASS("_TtC12Shadhin_RYZE19WebsocketsTransport") SWIFT_AVAILABILITY(tvos,introduced=13.0) SWIFT_AVAILABILITY(watchos,introduced=6.0) SWIFT_AVAILABILITY(ios,introduced=13.0) SWIFT_AVAILABILITY(macos,introduced=10.15)
